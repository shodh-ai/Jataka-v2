...
export default function SalesDeckPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAF8F3] text-[#1a1a1a]">
          ...
          <Reveal delay={300}>
            <div className="max-w-[900px] mx-auto">
              ...
              <div className="relative">
                ...
                <div className="absolute left-[24px] top-[60px] bottom-[60px] w-[1px] bg-gradient-to-b from-[#FF2424] via-[#FF2424]/50 to-transparent"></div>
                
                {/* Feature 1 */}
                <div className="relative flex items-start gap-[24px] mb-[60px] group">
                  <div className="relative z-10">
                    <div className="w-[48px] h-[48px] rounded-full bg-[#FF2424] flex items-center justify-center text-white font-archivo text-[16px] font-bold shadow-[0_4px_20px_rgba(255,36,36,0.3)] group-hover:scale-110 transition-transform">
                      1
                    </div>
                  </div>
                  <div className="flex-1 bg-white rounded-[12px] p-[32px] shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#1a1a1a]/5 hover:shadow-[0_8px_30px_rgba(255,36,36,0.08)] hover:border-[#FF2424]/20 transition-all duration-300">
                    <div className="flex items-center gap-[12px] mb-[16px]">
                      <div className="w-[8px] h-[8px] rounded-full bg-[#FF2424] animate-pulse"></div>
                      <p className="font-mono text-[12px] uppercase tracking-[2px] text-[#FF2424]">Kamikaze Pod</p>
                    </div>
                    <p className="font-archivo text-[18px] leading-[1.6] text-[#1a1a1a]">
                      When a PR is opened → Jataka automatically spawns an isolated Kamikaze Pod → physically executes the business transaction in your Sandbox → and dynamically profiles the Limits → If it hits 90%, we block the merge.
                    </p>
                  </div>
                </div>

                {/* Feature 2 */}
                <div className="relative flex items-start gap-[24px] group">
                  <div className="relative z-10">
                    <div className="w-[48px] h-[48px] rounded-full bg-[#FF2424] flex items-center justify-center text-white font-archivo text-[16px] font-bold shadow-[0_4px_20px_rgba(255,36,36,0.3)] group-hover:scale-110 transition-transform">
                      2
                    </div>
                  ...
                  <div className="flex-1 bg-white rounded-[12px] p-[32px] shadow-[0_4px_20px_rgba(0,0,0,0.03)] border border-[#1a1a1a]/5 hover:shadow-[0_8px_30px_rgba(255,36,36,0.08)] hover:border-[#FF2424]/20 transition-all duration-300">
                    <div className="flex items-center gap-[12px] mb-[16px]">
                      <div className="w-[8px] h-[8px] rounded-full bg-[#FF2424] animate-pulse"></div>
                      <p className="font-mono text-[12px] uppercase tracking-[2px] text-[#FF2424]">Tooling API Correlation</p>
                    </div>
                    <p className="font-archivo text-[18px] leading-[1.6] text-[#1a1a1a]">
                      Jataka dynamically correlates every frontend UI click → with the Salesforce Tooling API → to profile your asynchronous Governor Limits → ensuring what passes the UI won't crash the database.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-[60px] text-center">
                <div className="inline-flex items-center gap-[16px] px-[24px] py-[12px] bg-[#FF2424]/5 rounded-full border border-[#FF2424]/20">
                  <svg className="w-[20px] h-[20px] text-[#FF2424]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <p className="font-archivo text-[14px] text-[#FF2424] uppercase tracking-[1px]">
                    Zero Production Rollbacks Guaranteed
                  </p>
                </div>
              </div>
            </div>
      ...
      {/* ── SECTION 5: BUSINESS OUTCOME & ASK ── */}
      <section className="relative px-[40px] md:px-[80px] lg:px-[120px] xl:px-[160px] py-[100px] border-t border-[#1a1a1a]/10 bg-[#F5F0E8] overflow-hidden">
        <LightGridBg />
