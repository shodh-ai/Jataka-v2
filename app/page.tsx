    ...
    <>
      ...
      <section id="hero" className="min-h-screen flex flex-col items-center justify-center text-center px-[40px] pt-[128px] pb-[100px] relative overflow-hidden bg-[#FAF8F3]">
        ...
        <div className="flex gap-[16px] flex-wrap justify-center mb-[72px] relative z-10 flex-col md:flex-row w-full md:w-auto">
          <Link href="/book-pilot" className="bg-[#FF2424] text-white px-[32px] py-[14px] font-archivo text-[13px] uppercase tracking-[1.5px] rounded-[4px] hover:bg-[#d91f1f] transition-colors w-full md:w-auto justify-center text-center">
            ▶ Start Your Pilot
          </Link>
      ...
      <section id="final-cta" className="relative overflow-hidden bg-[#1a1a1a]">
        <div className="max-w-[1000px] mx-auto px-[24px] md:px-[48px] py-[100px] text-center relative z-10">
          ...
          <Link href="/book-pilot" className="bg-[#FF2424] text-white px-[40px] py-[16px] font-archivo text-[14px] uppercase tracking-[1.5px] rounded-[4px] hover:bg-[#d91f1f] transition-colors inline-block text-center">
            ▶ Start Your Pilot
          </Link>
        </div>
      </section>
