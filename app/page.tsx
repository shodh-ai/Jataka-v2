    ...
    <>
      ...
      <nav className="fixed top-0 left-0 right-0 z-[200] h-[64px] bg-[#FAF8F3]/90 backdrop-blur-[14px] border-b border-[#1a1a1a]/10 px-[24px] md:px-[48px] flex items-center justify-between">
        <div className="flex items-center">
          <Link href="/" className="flex items-center" onClick={(e) => { e.preventDefault(); scrollToSection("hero"); }}>
        ...
        <ul className="hidden md:flex gap-[24px] list-none items-center m-0 p-0">
          ...
          <li className="relative group">
            ...
            {dropdownOpen === 'product' && (
              ...
              >
                <Link href="/use-cases/limit-firewall" onClick={() => setDropdownOpen(null)} className="block w-full text-left px-[16px] py-[8px] hover:bg-[#FAF8F3] text-[13px] text-[#1a1a1a] transition-colors">Limit Firewall</Link>
                <Link href="/use-cases/automated-pr-reviews" onClick={() => setDropdownOpen(null)} className="block w-full text-left px-[16px] py-[8px] hover:bg-[#FAF8F3] text-[13px] text-[#1a1a1a] transition-colors">Automated PR Reviews</Link>
          ...
          <li className="relative group">
            ...
            {dropdownOpen === 'compare' && (
              <div 
                ...
                onMouseLeave={() => setDropdownOpen(null)}
              >
                <Link href="/compare/copado" onClick={() => setDropdownOpen(null)} className="block w-full text-left px-[16px] py-[8px] hover:bg-[#FAF8F3] text-[13px] text-[#1a1a1a] transition-colors">vs. Copado</Link>
                <Link href="/compare/clayton" onClick={() => setDropdownOpen(null)} className="block w-full text-left px-[16px] py-[8px] hover:bg-[#FAF8F3] text-[13px] text-[#1a1a1a] transition-colors">vs. Clayton</Link>
                <Link href="/compare/provar" onClick={() => setDropdownOpen(null)} className="block w-full text-left px-[16px] py-[8px] hover:bg-[#FAF8F3] text-[13px] text-[#1a1a1a] transition-colors">vs. Provar</Link>
              </div>
            )}
          </li>
          ...
          <li className="relative group">
            ...
            {dropdownOpen === 'resources' && (
              <div 
                ...
                onMouseLeave={() => setDropdownOpen(null)}
              >
                <a href="https://docs.jataka.io" target="_blank" rel="noopener noreferrer" onClick={() => setDropdownOpen(null)} className="block w-full text-left px-[16px] py-[8px] hover:bg-[#FAF8F3] text-[13px] text-[#1a1a1a] transition-colors">Documentation</a>
                <Link href="/anti-patterns" onClick={() => setDropdownOpen(null)} className="block w-full text-left px-[16px] py-[8px] hover:bg-[#FAF8F3] text-[13px] text-[#1a1a1a] transition-colors">Anti-Patterns Library</Link>
                <Link href="/blog" onClick={() => setDropdownOpen(null)} className="block w-full text-left px-[16px] py-[8px] hover:bg-[#FAF8F3] text-[13px] text-[#1a1a1a] transition-colors">Engineering Blog</Link>
                <Link href="/roi-calculator" onClick={() => setDropdownOpen(null)} className="block w-full text-left px-[16px] py-[8px] hover:bg-[#FAF8F3] text-[13px] text-[#1a1a1a] transition-colors">ROI Calculator</Link>
              </div>
            )}
          </li>

          <li><a href="https://app.jataka.io" target="_blank" rel="noopener noreferrer" className="text-[#666] hover:text-[#1a1a1a] transition-colors text-[13.5px] font-medium tracking-[0.4px]">Log In</a></li>
          <li><Link href="/book-pilot" className="bg-[#FF2424] text-white px-[20px] py-[8px] font-archivo text-[11px] uppercase tracking-[1.5px] rounded-[4px] hover:bg-[#d91f1f] transition-colors">Book a Demo</Link></li>
        </ul>
      ...
      <section id="hero" className="min-h-screen flex flex-col items-center justify-center text-center px-[40px] pt-[128px] pb-[100px] relative overflow-hidden bg-[#FAF8F3]">
        ...
        <div className="flex gap-[16px] flex-wrap justify-center mb-[72px] relative z-10 flex-col md:flex-row w-full md:w-auto">
          <Link href="/pilot" className="bg-[#FF2424] text-white px-[32px] py-[14px] font-archivo text-[13px] uppercase tracking-[1.5px] rounded-[4px] hover:bg-[#d91f1f] transition-colors w-full md:w-auto justify-center text-center">
            ▶ Start Your Pilot
          </Link>
          <Link href="/docs" className="bg-[#1a1a1a] text-white px-[32px] py-[14px] font-archivo text-[13px] uppercase tracking-[1.5px] rounded-[4px] hover:bg-[#333] transition-colors w-full md:w-auto justify-center text-center">
            ⬡ Read the Docs
          </Link>
        </div>
            ...
            <div className="col-span-1 md:col-span-2 grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-[40px] items-center bg-white p-[40px] md:p-[48px] rounded-[8px] border border-[#1a1a1a]/5">
              ...
              <div className="bg-[#1a1a1a] rounded-[8px] p-[32px] text-center">
                <p className="text-white/60 text-[14px] leading-[1.8]">
                  Salesforce architecture<br/>is a black box.<br/><br/>
                  <span className="text-[#FF2424] font-archivo text-[18px] uppercase">WE DECODED IT.<br/>WE PROTECT IT.</span>
                </p>
              </div>
            </div>

            {/* Feature 5 - Tech Debt & Org Bloat Prevention */}
            <div className="col-span-1 md:col-span-2 grid grid-cols-1 lg:grid-cols-[1fr_1fr] gap-[40px] items-center bg-white p-[40px] md:p-[48px] rounded-[8px] border border-[#1a1a1a]/5">
              <div>
                <h3 className="font-archivo text-[21px] uppercase tracking-[-0.4px] text-[#1a1a1a] mb-[16px] leading-[1.18]">Active Tech-Debt<br/>& Org Bloat Prevention</h3>
                <p className="text-[14.5px] leading-[1.75] text-[#444]">
                  ...
                  <strong className="text-[#1a1a1a] font-bold"> Knowledge Graph</strong> flags the duplication and blocks the PR. 
                  It enforces Flow-vs-Apex rules, identifies Orphan Nodes, and autonomously generates 
                  the exact <strong className="text-[#1a1a1a] font-bold">destructiveChanges.xml</strong> files to safely delete 10 years of legacy code.
                </p>
              </div>
              <div className="bg-[#1a1a1a] rounded-[8px] p-[32px] text-center">
                <p className="text-white/60 text-[14px] leading-[1.8]">
                  10 years of legacy code.<br/><br/>
                  <span className="text-[#FF2424] font-archivo text-[18px] uppercase">CLEANED IN 10 MINUTES.</span>
                </p>
              </div>
            </div>
      ...
      <section id="final-cta" className="relative overflow-hidden bg-[#1a1a1a]">
        <div className="max-w-[1000px] mx-auto px-[24px] md:px-[48px] py-[100px] text-center relative z-10">
          ...
          <Link href="/pilot" className="bg-[#FF2424] text-white px-[40px] py-[16px] font-archivo text-[14px] uppercase tracking-[1.5px] rounded-[4px] hover:bg-[#d91f1f] transition-colors inline-block text-center">
            ▶ Start Your Pilot
          </Link>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-[40px] md:gap-[60px] mb-[60px]">
            ...
            <div>
              ...
              <ul className="space-y-[12px]">
                <li><Link href="/use-cases/limit-firewall" className="text-[14px] text-[#999] hover:text-white transition-colors text-left block">Limit Firewall</Link></li>
                <li><Link href="/use-cases/automated-pr-reviews" className="text-[14px] text-[#999] hover:text-white transition-colors text-left block">Automated PR Reviews</Link></li>
                <li><Link href="/use-cases/self-healing-ui-tests" className="text-[14px] text-[#999] hover:text-white transition-colors text-left block">Self-Healing UI Tests</Link></li>
                <li><Link href="/use-cases/blast-radius-prediction" className="text-[14px] text-[#999] hover:text-white transition-colors text-left block">Blast Radius Prediction</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-[12px]">
                <li><Link href="/compare/copado" className="text-[14px] text-[#999] hover:text-white transition-colors text-left block">Jataka vs. Copado</Link></li>
                <li><Link href="/compare/clayton" className="text-[14px] text-[#999] hover:text-white transition-colors text-left block">Jataka vs. Clayton</Link></li>
                <li><Link href="/compare/provar" className="text-[14px] text-[#999] hover:text-white transition-colors text-left block">Jataka vs. Provar</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-[12px]">
                <li><a href="https://docs.jataka.io" target="_blank" rel="noopener noreferrer" className="text-[14px] text-[#999] hover:text-white transition-colors text-left block">Documentation</a></li>
                <li><Link href="/anti-patterns" className="text-[14px] text-[#999] hover:text-white transition-colors text-left block">Anti-Patterns Library</Link></li>
                <li><Link href="/blog" className="text-[14px] text-[#999] hover:text-white transition-colors text-left block">Engineering Blog</Link></li>
                <li><Link href="/roi-calculator" className="text-[14px] text-[#999] hover:text-white transition-colors text-left block">ROI Calculator</Link></li>
                <li><Link href="/demos" className="text-[14px] text-[#999] hover:text-white transition-colors text-left block">Product Demos</Link></li>
              </ul>
            </div>
