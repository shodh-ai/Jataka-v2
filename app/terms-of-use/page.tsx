...
export const metadata: Metadata = {
  title: "Terms of Use",
  description:
    "Jataka Terms of Use - Legal terms and conditions governing access to and use of Jataka's DevSecOps and Runtime Governance platform.",
  alternates: {
    canonical: "https://jataka.io/terms-of-use",
  },
  openGraph: {
    title: "Terms of Use | Jataka",
    description:
      "Jataka Terms of Use - Legal terms and conditions governing access to and use of Jataka's DevSecOps and Runtime Governance platform.",
    url: "https://jataka.io/terms-of-use",
    siteName: "Jataka",
...
If you are a paid subscriber to Jataka Inc. or are participating in a Proof of Concept, your use of the Services will be governed by the Master Subscription Agreement (MSA) or Proof of Concept Agreement, which shall supersede these Legal Terms in the event of any conflict.
...
6. SUBSCRIPTIONS
If you wish to purchase or subscribe to any product or service made available through the Services ("Purchase"), you may be asked to supply certain information relevant to your Purchase including, without limitation, your credit or debit card number, the expiration date of your card, your billing address, and your shipping information.
You agree and acknowledge that all Purchases are non-refundable and that there are no refunds or credits for partially used periods. You agree and acknowledge that you are not required to purchase the Services and that your decision to purchase the Services is at your sole discretion.
We reserve the right to change the subscription fees for any of our Services at any time. Any changes to subscription fees will be effective immediately upon posting on the Site or notifying you by email. Your continued use of the Services after such notification constitutes your acceptance of the new subscription fees.

7. PROHIBITED ACTIVITIES
You may not access or use the Services for any purpose other than that for which the Services are made available. The Services may not be used in connection with any commercial endeavors except those that are specifically endorsed or approved by us.
...
Engage in any automated use of the system, such as using scripts to send comments or messages, without our express written permission.
...
Upload or transmit (or attempt to upload or transmit) any material that acts as a passive or active information collection or transmission mechanism, including without limitation, clear graphics interchange formats ("gifs"), 1×1 pixel gifs, web bugs, cookies, or other similar devices (sometimes referred to as "spyware" or "passive collection mechanisms" or "pcms").
Interfere with or disrupt the Services or servers or networks connected to the Services, or disobey any requirements, procedures, policies or regulations of networks connected to the Services.
Provide false, inaccurate, or misleading information.
Use the Services in a manner that is inconsistent with any and all applicable laws and regulations.
